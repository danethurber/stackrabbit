...
describe('Application', () => {
  ...
  const settings = { rabbitUrl: 'asdf', queueName: 'qwer' }
  ...
  describe('#constructor', () => {
    ...
    it('should require a rabbitUrl', () => {
      const tmpSettings = Object.assign({}, settings, { rabbitUrl: null })
  ...
  describe('#connect', () => {
    ...
    it('should connect to a rabbit queue', function * () {
      ...
      expect(amqplib.connect.calledWith(settings.rabbitUrl)).to.be.true
