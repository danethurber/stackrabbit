...
describe('Application', () => {
  describe('#constructor', () => {
    it('should allow configuration', () => {
      const cfg = { rabbitUrl: 'asdf', queueName: 'qwer' }
      const app = new Application(cfg)

      expect(app._config).to.contain(cfg)
    })

    it('should require a rabbitUrl', () => {
      expect(() => {
        Application({ rabbitUrl: null, queueName: 'qwe' })
      }).to.throw(/rabbitUrl is required/)
    })

    it('should require a queueName', () => {
      expect(() => {
        Application({ rabbitUrl: 'asdf', queueName: null })
      }).to.throw(/queueName is required/)
    })

    it('should have an array of middleware', () => {
      const app = new Application({ rabbitUrl: 'asdf', queueName: 'qwer' })
    ...
    it('should be an EventEmitter', () => {
      ...
      expect(
        Application({ rabbitUrl: 'asdf', queueName: 'qwer' })
  ...
  describe('#use', () => {
    ...
    beforeEach(() => {
      app = new Application({ rabbitUrl: 'asdf', queueName: 'qwer' })
    })
